...
foreach ($list as $l) {
    ...
    copy('http://image.tmdb.org/t/p/original' . $infos->poster_path, '../api/data/series/poster/' . $l->tmdbid . '.jpg', $cxContext);
    copy('http://image.tmdb.org/t/p/w300' . $infos->poster_path, '../api/data/series/poster/' . $l->tmdbid . '_w300.jpg', $cxContext);
    /*
